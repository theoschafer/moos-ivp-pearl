...
VNAME1="pearl"           # The first vehicle Community
...
#----------------------------------------------------------
nsplug meta_vehicle.moos targ_pearl.moos -i -f WARP=$TIME_WARP \
...
nsplug meta_vehicle.bhv targ_pearl.bhv -i -f VNAME=$VNAME1    \
...
pAntler targ_pearl.moos >& /dev/null &
